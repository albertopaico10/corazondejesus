		...
		<div class='modal-content'>
			<div class='modal-header'>
				...
				<div id="idTitleModal">
					<h4 class='modal-title'>
						<spring:message code="maintenance.patient.title.add.part1" />
					</h4>				
				</div>
			</div>
			<html:form method="POST" commandName="maintenancePatientForm" action="registerPatient.htm" id="idMaintenancePatientForm" novalidate="novalidate">
				<div class="modal-body">
					...
					<div id="tabPart2" style="display: none">
						<div id="divFormDiv" class="formDiv">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-default btn_submit_modal" id="idSave" style="display: none">
						<spring:message code="maintenance.botton.new.form"/>
					</button>
					<button type="button" class="btn btn-default" id="back" style="display: none">
						<spring:message code="maintenance.botton.new.form.back" />
					</button>
					<button type="button" class="btn btn-default" id="next">
						<spring:message code="maintenance.botton.new.form.next" />
					</button>
...
<script>
	...
	$("#next").click(function() {
		if ($("#idMaintenancePatientForm").valid()) {
	...
	function showTabPart1(){
		$("#tabPart2").hide();
		$("#tabPart1").show();
		$("#idTitleModal" ).html('<h4 class="modal-title"><spring:message code="maintenance.patient.title.add.part2"/></h4>');
	}
	function showTabPart2(){
		$("#tabPart1").hide();
		$("#tabPart2").show();
		$("#idTitleModal" ).html('<h4 class="modal-title"><spring:message code="maintenance.patient.title.add.part1"/></h4>');
	}
