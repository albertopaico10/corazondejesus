...
public class TableNewPatientDaoImpl implements TableNewPatientDao {
	...
	public List<TbNewPatient> listAllNewPatientSpecific(TbNewPatient tbPatientBean){
		String query="from TbNewPatient where statusPatient=1 and (namePatient like '%"+tbPatientBean.getLastNamePatient()+"%' or lastNamePatient like '%"+tbPatientBean.getLastNamePatient()+"%') and dni like '%"+tbPatientBean.getDni()+"%'";
